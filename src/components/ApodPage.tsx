			...
			<div data-theme={theme} className="bg-white flex-col    dark:bg-navbar py-2 font">
				...
				<section className="grid grid-cols-2 gap-4">
					<div className="flex flex-col justify-center align-items m-16">
						...
						<button type="button" onClick={submitFav} className="text-white ml-4 mr-4 mt-8 bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Add to Favorite</button>
					</div>
